...
<div class="page">
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div id="context">
            ...
            <form action="../model/updatemodel.lovo" method="post">
            <input type="hidden" name="id" value="${md.fkMbid }">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" disabled value="${md.fMbname}">
                    </div>
                </div>
                <div class="form-group row" id="xiala">
                    ...
                    <div class="col-sm-9">
                        <select name="account" class="form-control mb-3" disabled>
                            <option value="火灾" ${md.fMbtype=="火灾"?'selected':''}><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">火灾</font></font></option>
                            <option value="房屋倒塌" ${md.fMbtype=="房屋倒塌"?'selected':''}><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">房屋倒塌</font></font></option>
                         </select>
                    </div>
                ...
                <div class="form-group row" id="xl">
                    ...
                    <div class="col-sm-9">
                        <select name="account" class="form-control mb-3" disabled>
                           <option value="1" ${md.fMbrank=="1"?'selected':''}><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">1</font></font></option>
                            <option value="2" ${md.fMbrank=="2"?'selected':''}><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">2</font></font></option>
                            <option value="3" ${md.fMbrank=="3"?'selected':''}><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">3</font></font></option>
                         </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="docNum" class="form-control" value="${md.fMbdocnum }">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="ambNum" class="form-control" value="${md.fMbambnum }">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="firNum" class="form-control" value="${md.fMbfirnum }">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="inferNum" class="form-control" value="${md.fMbinfernum }">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" disabled value="${md.fMbmeaker }">
                    </div>
                </div>
                 <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" disabled value="${md.fMbmakertel }">
                    </div>
                </div>
