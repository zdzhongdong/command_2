...
<div class="page">
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div id="context">
            ...
            <form action="../publi/addpublic.lovo" method="post">
                ...
                <div class="col-sm-9">
                    <select name="fType" class="form-control mb-3">
                        <option value="等级"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">模板等级</font></font></option>
                        <option value="类型"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">模板类型</font></font></option>
                   </select>
                </div>
                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="fKey">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="fValue">
                    </div>
                </div>
