...
@Service("amqSenderService2")
public class AMQSenderServiceImpl2 implements AmqSenderService{
	  private static final Logger logger = Logger.getLogger(AMQSenderServiceImpl2.class);

	    @Autowired
	    private JmsTemplate jmsTemplate;

	    //目的地队列的明证，我们要向这个队列发送消息
	    @Resource(name="sendToThree")
